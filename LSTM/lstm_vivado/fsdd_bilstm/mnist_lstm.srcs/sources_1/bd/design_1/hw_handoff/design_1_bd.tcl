...
proc create_root_design { parentCell } {
  ...
  # Create instance: BiLSTM_Top_0, and set properties
  set BiLSTM_Top_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:BiLSTM_Top:1.0 BiLSTM_Top_0 ]
  ...
  connect_bd_intf_net -intf_net BiLSTM_Top_0_output_stream [get_bd_intf_pins BiLSTM_Top_0/output_stream] [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM]
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins BiLSTM_Top_0/input_stream] [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S]
