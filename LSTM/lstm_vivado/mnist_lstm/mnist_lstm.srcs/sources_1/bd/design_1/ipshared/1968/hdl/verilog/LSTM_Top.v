...
(* CORE_GENERATION_INFO="LSTM_Top,hls_ip_2018_3,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020clg400-2,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=9.235000,HLS_SYN_LAT=58177,HLS_SYN_TPT=none,HLS_SYN_MEM=245,HLS_SYN_DSP=620,HLS_SYN_FF=36668,HLS_SYN_LUT=47737,HLS_VERSION=2018_3}" *)
...
wire    grp_mnist_lstm_fu_74_ap_start;
wire    grp_mnist_lstm_fu_74_ap_done;
wire    grp_mnist_lstm_fu_74_ap_idle;
wire    grp_mnist_lstm_fu_74_ap_ready;
wire    grp_mnist_lstm_fu_74_in_r_TVALID;
wire    grp_mnist_lstm_fu_74_in_r_TREADY;
wire   [31:0] grp_mnist_lstm_fu_74_out_r_TDATA;
wire    grp_mnist_lstm_fu_74_out_r_TVALID;
wire    grp_mnist_lstm_fu_74_out_r_TREADY;
wire   [3:0] grp_mnist_lstm_fu_74_out_r_TKEEP;
wire   [3:0] grp_mnist_lstm_fu_74_out_r_TSTRB;
wire   [0:0] grp_mnist_lstm_fu_74_out_r_TUSER;
wire   [0:0] grp_mnist_lstm_fu_74_out_r_TLAST;
wire   [0:0] grp_mnist_lstm_fu_74_out_r_TID;
wire   [0:0] grp_mnist_lstm_fu_74_out_r_TDEST;
reg    grp_mnist_lstm_fu_74_ap_start_reg;
...
#0 grp_mnist_lstm_fu_74_ap_start_reg = 1'b0;
#0 ap_CS_fsm = 4'd1;
end
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        grp_mnist_lstm_fu_74_ap_start_reg <= 1'b0;
    end else begin
        if ((1'b1 == ap_CS_fsm_state2)) begin
            grp_mnist_lstm_fu_74_ap_start_reg <= 1'b1;
        end else if ((grp_mnist_lstm_fu_74_ap_ready == 1'b1)) begin
            grp_mnist_lstm_fu_74_ap_start_reg <= 1'b0;
        end
    end
end
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state3 : begin
            if (((grp_mnist_lstm_fu_74_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state3))) begin
...
assign grp_mnist_lstm_fu_74_ap_start = grp_mnist_lstm_fu_74_ap_start_reg;

assign grp_mnist_lstm_fu_74_in_r_TVALID = in_dest_V_0_state[1'd0];

assign grp_mnist_lstm_fu_74_out_r_TREADY = ((out_dest_V_1_ack_in & ap_CS_fsm_state3) | (out_id_V_1_ack_in & ap_CS_fsm_state3) | (out_last_V_1_ack_in & ap_CS_fsm_state3) | (out_user_V_1_ack_in & ap_CS_fsm_state3) | (out_strb_V_1_ack_in & ap_CS_fsm_state3) | (out_keep_V_1_ack_in & ap_CS_fsm_state3) | (out_data_V_1_ack_in & ap_CS_fsm_state3));
...
assign out_data_V_1_vld_in = grp_mnist_lstm_fu_74_out_r_TVALID;
...
assign out_dest_V_1_vld_in = grp_mnist_lstm_fu_74_out_r_TVALID;
...
assign out_id_V_1_vld_in = grp_mnist_lstm_fu_74_out_r_TVALID;
...
assign out_keep_V_1_vld_in = grp_mnist_lstm_fu_74_out_r_TVALID;
...
assign out_last_V_1_vld_in = grp_mnist_lstm_fu_74_out_r_TVALID;
...
assign out_strb_V_1_vld_in = grp_mnist_lstm_fu_74_out_r_TVALID;
...
assign out_user_V_1_vld_in = grp_mnist_lstm_fu_74_out_r_TVALID;
