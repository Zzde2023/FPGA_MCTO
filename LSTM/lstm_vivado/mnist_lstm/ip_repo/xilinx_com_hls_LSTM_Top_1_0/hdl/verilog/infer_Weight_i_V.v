// ==============================================================
// File generated on Wed Apr 16 03:09:25 +0800 2025
...
// ==============================================================
`timescale 1 ns / 1 ps
(* rom_style = "block" *) module infer_Weight_i_V_rom (
...
initial begin
    $readmemh("./infer_Weight_i_V_rom.dat", ram0);
    $readmemh("./infer_Weight_i_V_rom.dat", ram1);
    $readmemh("./infer_Weight_i_V_rom.dat", ram2);
end
...
infer_Weight_i_V_rom infer_Weight_i_V_rom_U(
    .clk( clk ),
    .addr0( address0 ),
    .ce0( ce0 ),
    .q0( q0 ),
