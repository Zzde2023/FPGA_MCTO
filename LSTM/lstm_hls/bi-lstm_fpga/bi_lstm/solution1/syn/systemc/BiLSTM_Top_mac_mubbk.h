...
// ==============================================================
#ifndef __BiLSTM_Top_mac_mubbk__HH__
#define __BiLSTM_Top_mac_mubbk__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(BiLSTM_Top_mac_mubbk) {
    ...
    SC_CTOR(BiLSTM_Top_mac_mubbk):  simcore_mac_1_U ("simcore_mac_1_U") {
