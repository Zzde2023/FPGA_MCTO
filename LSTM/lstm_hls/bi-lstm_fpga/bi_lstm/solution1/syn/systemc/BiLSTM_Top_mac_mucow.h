...
// ==============================================================
#ifndef __BiLSTM_Top_mac_mucow__HH__
#define __BiLSTM_Top_mac_mucow__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(BiLSTM_Top_mac_mucow) {
    ...
    SC_CTOR(BiLSTM_Top_mac_mucow):  simcore_mac_4_U ("simcore_mac_4_U") {
