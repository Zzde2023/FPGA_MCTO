...
// ==============================================================
#ifndef __BiLSTM_Top_mac_mu9j0__HH__
#define __BiLSTM_Top_mac_mu9j0__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(BiLSTM_Top_mac_mu9j0) {
    ...
    SC_CTOR(BiLSTM_Top_mac_mu9j0):  simcore_mac_0_U ("simcore_mac_0_U") {
