// ==============================================================
// File generated on Sat Apr 19 01:59:59 +0800 2025
...
#ifndef _BiLSTM_Top_input_cKz_H_
#define _BiLSTM_Top_input_cKz_H_

#include <systemc>
#include <iostream>
#include <fstream>

#include "BiLSTM_Top_input_cKz_memcore.h"

SC_MODULE(BiLSTM_Top_input_cKz) {
...
protected:
    ...
    BiLSTM_Top_input_cKz_memcore* BiLSTM_Top_input_cKz_memcore_U;
...
public:
    ...
    SC_CTOR(BiLSTM_Top_input_cKz) : m_trace_file(0) {
        SC_METHOD(proc_memcore_addr);
        sensitive << i_address0 << t_address0 << iptr << tptr;

        BiLSTM_Top_input_cKz_memcore_U = new BiLSTM_Top_input_cKz_memcore("BiLSTM_Top_input_cKz_memcore_U");
        BiLSTM_Top_input_cKz_memcore_U->clk      ( clk );
        BiLSTM_Top_input_cKz_memcore_U->reset    ( reset );
        BiLSTM_Top_input_cKz_memcore_U->ce0      ( i_ce0 );
        BiLSTM_Top_input_cKz_memcore_U->we0      ( i_we0 );
        BiLSTM_Top_input_cKz_memcore_U->address0 ( memcore_iaddr );
        BiLSTM_Top_input_cKz_memcore_U->d0       ( i_d0 );
        BiLSTM_Top_input_cKz_memcore_U->q0       ( i_q0 );

        BiLSTM_Top_input_cKz_memcore_U->ce1      ( t_ce0 );
        BiLSTM_Top_input_cKz_memcore_U->we1      ( t_we0 );
        BiLSTM_Top_input_cKz_memcore_U->address1 ( memcore_taddr );
        BiLSTM_Top_input_cKz_memcore_U->d1       ( t_d0 );
        BiLSTM_Top_input_cKz_memcore_U->q1       ( t_q0 );
        ...
        if (dump_vcd) {
            m_trace_file = sc_create_vcd_trace_file( "BiLSTM_Top_input_cKz.trace");
            // ports
