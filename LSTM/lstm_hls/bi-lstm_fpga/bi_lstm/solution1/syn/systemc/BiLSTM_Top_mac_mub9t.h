...
// ==============================================================
#ifndef __BiLSTM_Top_mac_mub9t__HH__
#define __BiLSTM_Top_mac_mub9t__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(BiLSTM_Top_mac_mub9t) {
    ...
    SC_CTOR(BiLSTM_Top_mac_mub9t):  simcore_mac_3_U ("simcore_mac_3_U") {
