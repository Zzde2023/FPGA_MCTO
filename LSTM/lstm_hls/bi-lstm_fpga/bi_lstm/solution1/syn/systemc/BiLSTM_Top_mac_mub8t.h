...
// ==============================================================
#ifndef __BiLSTM_Top_mac_mub8t__HH__
#define __BiLSTM_Top_mac_mub8t__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(BiLSTM_Top_mac_mub8t) {
    ...
    SC_CTOR(BiLSTM_Top_mac_mub8t):  simcore_mac_2_U ("simcore_mac_2_U") {
