...
// ==============================================================
#ifndef __BiLSTM_Top_mul_mubck__HH__
#define __BiLSTM_Top_mul_mubck__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(BiLSTM_Top_mul_mubck) {
    ...
    SC_CTOR(BiLSTM_Top_mul_mubck):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
