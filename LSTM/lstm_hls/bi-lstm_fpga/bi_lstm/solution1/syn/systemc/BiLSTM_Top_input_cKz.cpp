...
void BiLSTM_Top_input_cKz::proc_tptr() {
    if (reset.read() == SC_LOGIC_1) {
        tptr.write(0);
...
void BiLSTM_Top_input_cKz::proc_count() {
    if (reset.read() == SC_LOGIC_1) {
        count.write(0);
...
void BiLSTM_Top_input_cKz::proc_full_n() {
    if (reset.read() == SC_LOGIC_1) {
...
void BiLSTM_Top_input_cKz::proc_empty_n() {
    if (reset.read() == SC_LOGIC_1) {
