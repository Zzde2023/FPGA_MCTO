...
architecture behav of read_input is 
    ...
    signal i_i_reg_87 : STD_LOGIC_VECTOR (11 downto 0);
    signal tmp_1_i_fu_119_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_CS_fsm_state3 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state3 : signal is "none";
    signal tmp_i_49_fu_134_p3 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    ...
    i_i_reg_87_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((not(((exitcond_i_fu_98_p2 = ap_const_lv1_0) and (input_stream_V_data_V_0_vld_out = ap_const_logic_0))) and (exitcond_i_fu_98_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
    ...
    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, ap_CS_fsm_state1, input_stream_V_data_V_0_vld_out, ap_CS_fsm_state2, exitcond_i_fu_98_p2)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state2 => 
                if ((not(((exitcond_i_fu_98_p2 = ap_const_lv1_0) and (input_stream_V_data_V_0_vld_out = ap_const_logic_0))) and (exitcond_i_fu_98_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state2))) then
                    ap_NS_fsm <= ap_ST_fsm_state2;
                elsif ((not(((exitcond_i_fu_98_p2 = ap_const_lv1_0) and (input_stream_V_data_V_0_vld_out = ap_const_logic_0))) and (exitcond_i_fu_98_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then
    ...
    ap_block_state2_assign_proc : process(input_stream_V_data_V_0_vld_out, exitcond_i_fu_98_p2)
    begin
                ap_block_state2 <= ((exitcond_i_fu_98_p2 = ap_const_lv1_0) and (input_stream_V_data_V_0_vld_out = ap_const_logic_0));
    end process;
    ...
    exitcond_i_fu_98_p2 <= "1" when (i_i_reg_87 = ap_const_lv12_F3C) else "0";
    i_fu_104_p2 <= std_logic_vector(unsigned(i_i_reg_87) + unsigned(ap_const_lv12_1));
    input_buf_address0 <= tmp_1_i_fu_119_p1(12 - 1 downto 0);

    input_buf_ce0_assign_proc : process(input_stream_V_data_V_0_vld_out, ap_CS_fsm_state2, exitcond_i_fu_98_p2)
    begin
        if ((not(((exitcond_i_fu_98_p2 = ap_const_lv1_0) and (input_stream_V_data_V_0_vld_out = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
    ...
    input_buf_d0 <= input_stream_V_data_V_0_data_out;

    input_buf_we0_assign_proc : process(input_stream_V_data_V_0_vld_out, ap_CS_fsm_state2, exitcond_i_fu_98_p2)
    begin
        if ((not(((exitcond_i_fu_98_p2 = ap_const_lv1_0) and (input_stream_V_data_V_0_vld_out = ap_const_logic_0))) and (exitcond_i_fu_98_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
    ...
    input_stream_TDATA_blk_n_assign_proc : process(input_stream_V_data_V_0_state, ap_CS_fsm_state2, exitcond_i_fu_98_p2)
    begin
        if (((exitcond_i_fu_98_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
    ...
    input_stream_V_data_V_0_ack_out_assign_proc : process(input_stream_V_data_V_0_vld_out, ap_CS_fsm_state2, exitcond_i_fu_98_p2)
    begin
        if ((not(((exitcond_i_fu_98_p2 = ap_const_lv1_0) and (input_stream_V_data_V_0_vld_out = ap_const_logic_0))) and (exitcond_i_fu_98_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
    ...
    input_stream_V_dest_V_0_ack_out_assign_proc : process(input_stream_V_data_V_0_vld_out, ap_CS_fsm_state2, exitcond_i_fu_98_p2)
    begin
        if ((not(((exitcond_i_fu_98_p2 = ap_const_lv1_0) and (input_stream_V_data_V_0_vld_out = ap_const_logic_0))) and (exitcond_i_fu_98_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
    ...
    seq_o_assign_proc : process(seq_i, ap_CS_fsm_state3, tmp_i_49_fu_134_p3)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state3)) then 
    ...
    tmp_1_i_fu_119_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(i_i_reg_87),64));
    tmp_i_49_fu_134_p3 <= 
        ap_const_lv32_0 when (tmp_i_fu_128_p2(0) = '1') else 
        seq_i;
    tmp_i_fu_128_p2 <= "1" when (seq_i = ap_const_lv32_12C) else "0";
end behav;
