...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename input_buf \
    op interface \
    ports { input_buf_address0 { O 12 vector } input_buf_ce0 { O 1 bit } input_buf_we0 { O 1 bit } input_buf_d0 { O 32 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_seq \
    op interface \
    ports { seq_i { I 32 vector } seq_o { O 32 vector } seq_o_ap_vld { O 1 bit } } \
} "
}
