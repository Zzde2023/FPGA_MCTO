...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename input_b_V \
    op interface \
    ports { input_b_V_address0 { O 12 vector } input_b_V_ce0 { O 1 bit } input_b_V_we0 { O 1 bit } input_b_V_d0 { O 16 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename input_f_V \
    op interface \
    ports { input_f_V_address0 { O 12 vector } input_f_V_ce0 { O 1 bit } input_f_V_we0 { O 1 bit } input_f_V_d0 { O 16 vector } input_f_V_address1 { O 12 vector } input_f_V_ce1 { O 1 bit } input_f_V_we1 { O 1 bit } input_f_V_d1 { O 16 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_valid_len_out \
    op interface \
    ports { valid_len_out_din { O 7 vector } valid_len_out_full_n { I 1 bit } valid_len_out_write { O 1 bit } } \
} "
}
