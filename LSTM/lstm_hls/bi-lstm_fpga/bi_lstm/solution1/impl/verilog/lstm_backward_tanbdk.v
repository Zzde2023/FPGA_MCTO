...
// ==============================================================
`timescale 1 ns / 1 ps
(* rom_style = "block" *) module lstm_backward_tanbdk_rom (
...
initial begin
    $readmemh("./lstm_backward_tanbdk_rom.dat", ram0);
    $readmemh("./lstm_backward_tanbdk_rom.dat", ram1);
    $readmemh("./lstm_backward_tanbdk_rom.dat", ram2);
end
...
lstm_backward_tanbdk_rom lstm_backward_tanbdk_rom_U(
    .clk( clk ),
    .addr0( address0 ),
    .ce0( ce0 ),
    .q0( q0 ),
