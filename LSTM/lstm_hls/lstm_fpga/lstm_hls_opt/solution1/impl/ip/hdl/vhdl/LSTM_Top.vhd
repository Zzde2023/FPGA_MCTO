...
architecture behav of LSTM_Top is 
    ...
    "LSTM_Top,hls_ip_2018_3,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020clg400-2,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=9.235000,HLS_SYN_LAT=58177,HLS_SYN_TPT=none,HLS_SYN_MEM=245,HLS_SYN_DSP=620,HLS_SYN_FF=36668,HLS_SYN_LUT=47737,HLS_VERSION=2018_3}";
    ...
    signal grp_mnist_lstm_fu_74_ap_start : STD_LOGIC;
    signal grp_mnist_lstm_fu_74_ap_done : STD_LOGIC;
    signal grp_mnist_lstm_fu_74_ap_idle : STD_LOGIC;
    signal grp_mnist_lstm_fu_74_ap_ready : STD_LOGIC;
    signal grp_mnist_lstm_fu_74_in_r_TVALID : STD_LOGIC;
    signal grp_mnist_lstm_fu_74_in_r_TREADY : STD_LOGIC;
    signal grp_mnist_lstm_fu_74_out_r_TDATA : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_mnist_lstm_fu_74_out_r_TVALID : STD_LOGIC;
    signal grp_mnist_lstm_fu_74_out_r_TREADY : STD_LOGIC;
    signal grp_mnist_lstm_fu_74_out_r_TKEEP : STD_LOGIC_VECTOR (3 downto 0);
    signal grp_mnist_lstm_fu_74_out_r_TSTRB : STD_LOGIC_VECTOR (3 downto 0);
    signal grp_mnist_lstm_fu_74_out_r_TUSER : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_mnist_lstm_fu_74_out_r_TLAST : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_mnist_lstm_fu_74_out_r_TID : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_mnist_lstm_fu_74_out_r_TDEST : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_mnist_lstm_fu_74_ap_start_reg : STD_LOGIC := '0';
...
begin
    grp_mnist_lstm_fu_74 : component mnist_lstm
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
        ap_start => grp_mnist_lstm_fu_74_ap_start,
        ap_done => grp_mnist_lstm_fu_74_ap_done,
        ap_idle => grp_mnist_lstm_fu_74_ap_idle,
        ap_ready => grp_mnist_lstm_fu_74_ap_ready,
        in_r_TDATA => in_data_V_0_data_out,
        in_r_TVALID => grp_mnist_lstm_fu_74_in_r_TVALID,
        in_r_TREADY => grp_mnist_lstm_fu_74_in_r_TREADY,
        ...
        out_r_TDATA => grp_mnist_lstm_fu_74_out_r_TDATA,
        out_r_TVALID => grp_mnist_lstm_fu_74_out_r_TVALID,
        out_r_TREADY => grp_mnist_lstm_fu_74_out_r_TREADY,
        out_r_TKEEP => grp_mnist_lstm_fu_74_out_r_TKEEP,
        out_r_TSTRB => grp_mnist_lstm_fu_74_out_r_TSTRB,
        out_r_TUSER => grp_mnist_lstm_fu_74_out_r_TUSER,
        out_r_TLAST => grp_mnist_lstm_fu_74_out_r_TLAST,
        out_r_TID => grp_mnist_lstm_fu_74_out_r_TID,
        out_r_TDEST => grp_mnist_lstm_fu_74_out_r_TDEST);
    ...
    grp_mnist_lstm_fu_74_ap_start_reg_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                ...
                elsif ((grp_mnist_lstm_fu_74_ap_ready = ap_const_logic_1)) then 
                    grp_mnist_lstm_fu_74_ap_start_reg <= ap_const_logic_0;
                end if; 
            end if;
        end if;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((out_data_V_1_load_A = ap_const_logic_1)) then
                out_data_V_1_payload_A <= grp_mnist_lstm_fu_74_out_r_TDATA;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((out_data_V_1_load_B = ap_const_logic_1)) then
                out_data_V_1_payload_B <= grp_mnist_lstm_fu_74_out_r_TDATA;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((out_dest_V_1_load_A = ap_const_logic_1)) then
                out_dest_V_1_payload_A <= grp_mnist_lstm_fu_74_out_r_TDEST;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((out_dest_V_1_load_B = ap_const_logic_1)) then
                out_dest_V_1_payload_B <= grp_mnist_lstm_fu_74_out_r_TDEST;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((out_id_V_1_load_A = ap_const_logic_1)) then
                out_id_V_1_payload_A <= grp_mnist_lstm_fu_74_out_r_TID;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((out_id_V_1_load_B = ap_const_logic_1)) then
                out_id_V_1_payload_B <= grp_mnist_lstm_fu_74_out_r_TID;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((out_keep_V_1_load_A = ap_const_logic_1)) then
                out_keep_V_1_payload_A <= grp_mnist_lstm_fu_74_out_r_TKEEP;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((out_keep_V_1_load_B = ap_const_logic_1)) then
                out_keep_V_1_payload_B <= grp_mnist_lstm_fu_74_out_r_TKEEP;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((out_last_V_1_load_A = ap_const_logic_1)) then
                out_last_V_1_payload_A <= grp_mnist_lstm_fu_74_out_r_TLAST;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((out_last_V_1_load_B = ap_const_logic_1)) then
                out_last_V_1_payload_B <= grp_mnist_lstm_fu_74_out_r_TLAST;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((out_strb_V_1_load_A = ap_const_logic_1)) then
                out_strb_V_1_payload_A <= grp_mnist_lstm_fu_74_out_r_TSTRB;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((out_strb_V_1_load_B = ap_const_logic_1)) then
                out_strb_V_1_payload_B <= grp_mnist_lstm_fu_74_out_r_TSTRB;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((out_user_V_1_load_A = ap_const_logic_1)) then
                out_user_V_1_payload_A <= grp_mnist_lstm_fu_74_out_r_TUSER;
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state3 => 
                if (((grp_mnist_lstm_fu_74_ap_done = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state3))) then
    ...
    grp_mnist_lstm_fu_74_ap_start <= grp_mnist_lstm_fu_74_ap_start_reg;
    grp_mnist_lstm_fu_74_in_r_TVALID <= in_dest_V_0_state(0);
    grp_mnist_lstm_fu_74_out_r_TREADY <= ((out_dest_V_1_ack_in and ap_CS_fsm_state3) or (out_id_V_1_ack_in and ap_CS_fsm_state3) or (out_last_V_1_ack_in and ap_CS_fsm_state3) or (out_user_V_1_ack_in and ap_CS_fsm_state3) or (out_strb_V_1_ack_in and ap_CS_fsm_state3) or (out_keep_V_1_ack_in and ap_CS_fsm_state3) or (out_data_V_1_ack_in and ap_CS_fsm_state3));
    in_data_V_0_ack_in <= in_data_V_0_state(1);

    in_data_V_0_ack_out_assign_proc : process(grp_mnist_lstm_fu_74_in_r_TREADY, ap_CS_fsm_state3)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state3)) then 
            in_data_V_0_ack_out <= grp_mnist_lstm_fu_74_in_r_TREADY;
        else 
    ...
    in_dest_V_0_ack_out_assign_proc : process(grp_mnist_lstm_fu_74_in_r_TREADY, ap_CS_fsm_state3)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state3)) then 
            in_dest_V_0_ack_out <= grp_mnist_lstm_fu_74_in_r_TREADY;
        else 
    ...
    in_id_V_0_ack_out_assign_proc : process(grp_mnist_lstm_fu_74_in_r_TREADY, ap_CS_fsm_state3)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state3)) then 
            in_id_V_0_ack_out <= grp_mnist_lstm_fu_74_in_r_TREADY;
        else 
    ...
    in_keep_V_0_ack_out_assign_proc : process(grp_mnist_lstm_fu_74_in_r_TREADY, ap_CS_fsm_state3)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state3)) then 
            in_keep_V_0_ack_out <= grp_mnist_lstm_fu_74_in_r_TREADY;
        else 
    ...
    in_last_V_0_ack_out_assign_proc : process(grp_mnist_lstm_fu_74_in_r_TREADY, ap_CS_fsm_state3)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state3)) then 
            in_last_V_0_ack_out <= grp_mnist_lstm_fu_74_in_r_TREADY;
        else 
    ...
    in_strb_V_0_ack_out_assign_proc : process(grp_mnist_lstm_fu_74_in_r_TREADY, ap_CS_fsm_state3)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state3)) then 
            in_strb_V_0_ack_out <= grp_mnist_lstm_fu_74_in_r_TREADY;
        else 
    ...
    in_user_V_0_ack_out_assign_proc : process(grp_mnist_lstm_fu_74_in_r_TREADY, ap_CS_fsm_state3)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state3)) then 
            in_user_V_0_ack_out <= grp_mnist_lstm_fu_74_in_r_TREADY;
        else 
    ...
    out_data_V_1_vld_in <= grp_mnist_lstm_fu_74_out_r_TVALID;
    ...
    out_dest_V_1_vld_in <= grp_mnist_lstm_fu_74_out_r_TVALID;
    ...
    out_id_V_1_vld_in <= grp_mnist_lstm_fu_74_out_r_TVALID;
    ...
    out_keep_V_1_vld_in <= grp_mnist_lstm_fu_74_out_r_TVALID;
    ...
    out_last_V_1_vld_in <= grp_mnist_lstm_fu_74_out_r_TVALID;
    ...
    out_strb_V_1_vld_in <= grp_mnist_lstm_fu_74_out_r_TVALID;
    ...
    out_user_V_1_vld_in <= grp_mnist_lstm_fu_74_out_r_TVALID;
