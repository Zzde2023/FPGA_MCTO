...
// ==============================================================
#ifndef __LSTM_Top_dcmp_64nbkb__HH__
#define __LSTM_Top_dcmp_64nbkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(LSTM_Top_dcmp_64nbkb) {
    ...
    SC_CTOR(LSTM_Top_dcmp_64nbkb):  ACMP_dcmp_comb_U ("ACMP_dcmp_comb_U") {
