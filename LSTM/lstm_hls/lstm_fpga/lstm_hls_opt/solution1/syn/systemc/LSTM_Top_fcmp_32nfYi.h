...
// ==============================================================
#ifndef __LSTM_Top_fcmp_32nfYi__HH__
#define __LSTM_Top_fcmp_32nfYi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(LSTM_Top_fcmp_32nfYi) {
    ...
    SC_CTOR(LSTM_Top_fcmp_32nfYi):  ACMP_fcmp_comb_U ("ACMP_fcmp_comb_U") {
