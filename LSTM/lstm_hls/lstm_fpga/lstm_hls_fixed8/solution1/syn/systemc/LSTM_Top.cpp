...
LSTM_Top::LSTM_Top(sc_module_name name) : sc_module(name), mVcdFile(0) {
    grp_mnist_lstm_fu_70 = new mnist_lstm("grp_mnist_lstm_fu_70");
    grp_mnist_lstm_fu_70->ap_clk(ap_clk);
    grp_mnist_lstm_fu_70->ap_rst(ap_rst_n_inv);
    grp_mnist_lstm_fu_70->ap_start(grp_mnist_lstm_fu_70_ap_start);
    grp_mnist_lstm_fu_70->ap_done(grp_mnist_lstm_fu_70_ap_done);
    grp_mnist_lstm_fu_70->ap_idle(grp_mnist_lstm_fu_70_ap_idle);
    grp_mnist_lstm_fu_70->ap_ready(grp_mnist_lstm_fu_70_ap_ready);
    grp_mnist_lstm_fu_70->in_r_TDATA(in_data_V_0_data_out);
    grp_mnist_lstm_fu_70->in_r_TVALID(grp_mnist_lstm_fu_70_in_r_TVALID);
    grp_mnist_lstm_fu_70->in_r_TREADY(grp_mnist_lstm_fu_70_in_r_TREADY);
    grp_mnist_lstm_fu_70->in_r_TKEEP(in_keep_V_0_data_out);
    grp_mnist_lstm_fu_70->in_r_TSTRB(in_strb_V_0_data_out);
    grp_mnist_lstm_fu_70->in_r_TUSER(in_user_V_0_data_out);
    grp_mnist_lstm_fu_70->in_r_TLAST(in_last_V_0_data_out);
    grp_mnist_lstm_fu_70->in_r_TID(in_id_V_0_data_out);
    grp_mnist_lstm_fu_70->in_r_TDEST(in_dest_V_0_data_out);
    grp_mnist_lstm_fu_70->out_r_TDATA(grp_mnist_lstm_fu_70_out_r_TDATA);
    grp_mnist_lstm_fu_70->out_r_TVALID(grp_mnist_lstm_fu_70_out_r_TVALID);
    grp_mnist_lstm_fu_70->out_r_TREADY(grp_mnist_lstm_fu_70_out_r_TREADY);
    grp_mnist_lstm_fu_70->out_r_TKEEP(grp_mnist_lstm_fu_70_out_r_TKEEP);
    grp_mnist_lstm_fu_70->out_r_TSTRB(grp_mnist_lstm_fu_70_out_r_TSTRB);
    grp_mnist_lstm_fu_70->out_r_TUSER(grp_mnist_lstm_fu_70_out_r_TUSER);
    grp_mnist_lstm_fu_70->out_r_TLAST(grp_mnist_lstm_fu_70_out_r_TLAST);
    grp_mnist_lstm_fu_70->out_r_TID(grp_mnist_lstm_fu_70_out_r_TID);
    grp_mnist_lstm_fu_70->out_r_TDEST(grp_mnist_lstm_fu_70_out_r_TDEST);
    ...
    SC_METHOD(thread_grp_mnist_lstm_fu_70_ap_start);
    sensitive << ( grp_mnist_lstm_fu_70_ap_start_reg );

    SC_METHOD(thread_grp_mnist_lstm_fu_70_in_r_TVALID);
    sensitive << ( in_dest_V_0_state );

    SC_METHOD(thread_grp_mnist_lstm_fu_70_out_r_TREADY);
    sensitive << ( out_data_V_1_ack_in );
    sensitive << ( out_keep_V_1_ack_in );
    sensitive << ( out_strb_V_1_ack_in );
    sensitive << ( out_user_V_1_ack_in );
    ...
    sensitive << ( grp_mnist_lstm_fu_70_in_r_TREADY );
    sensitive << ( ap_CS_fsm_state3 );
    ...
    sensitive << ( grp_mnist_lstm_fu_70_out_r_TVALID );
    sensitive << ( ap_CS_fsm_state3 );
    ...
    sensitive << ( out_dest_V_1_ack_in );
    sensitive << ( out_dest_V_1_state );
    sensitive << ( grp_mnist_lstm_fu_70_ap_done );
    sensitive << ( ap_CS_fsm );
    sensitive << ( ap_CS_fsm_state3 );
    ...
    grp_mnist_lstm_fu_70_ap_start_reg = SC_LOGIC_0;
    ap_CS_fsm = "0001";
    ...
    sc_trace(mVcdFile, grp_mnist_lstm_fu_70_ap_start, "grp_mnist_lstm_fu_70_ap_start");
    sc_trace(mVcdFile, grp_mnist_lstm_fu_70_ap_done, "grp_mnist_lstm_fu_70_ap_done");
    sc_trace(mVcdFile, grp_mnist_lstm_fu_70_ap_idle, "grp_mnist_lstm_fu_70_ap_idle");
    sc_trace(mVcdFile, grp_mnist_lstm_fu_70_ap_ready, "grp_mnist_lstm_fu_70_ap_ready");
    sc_trace(mVcdFile, grp_mnist_lstm_fu_70_in_r_TVALID, "grp_mnist_lstm_fu_70_in_r_TVALID");
    sc_trace(mVcdFile, grp_mnist_lstm_fu_70_in_r_TREADY, "grp_mnist_lstm_fu_70_in_r_TREADY");
    sc_trace(mVcdFile, grp_mnist_lstm_fu_70_out_r_TDATA, "grp_mnist_lstm_fu_70_out_r_TDATA");
    sc_trace(mVcdFile, grp_mnist_lstm_fu_70_out_r_TVALID, "grp_mnist_lstm_fu_70_out_r_TVALID");
    sc_trace(mVcdFile, grp_mnist_lstm_fu_70_out_r_TREADY, "grp_mnist_lstm_fu_70_out_r_TREADY");
    sc_trace(mVcdFile, grp_mnist_lstm_fu_70_out_r_TKEEP, "grp_mnist_lstm_fu_70_out_r_TKEEP");
    sc_trace(mVcdFile, grp_mnist_lstm_fu_70_out_r_TSTRB, "grp_mnist_lstm_fu_70_out_r_TSTRB");
    sc_trace(mVcdFile, grp_mnist_lstm_fu_70_out_r_TUSER, "grp_mnist_lstm_fu_70_out_r_TUSER");
    sc_trace(mVcdFile, grp_mnist_lstm_fu_70_out_r_TLAST, "grp_mnist_lstm_fu_70_out_r_TLAST");
    sc_trace(mVcdFile, grp_mnist_lstm_fu_70_out_r_TID, "grp_mnist_lstm_fu_70_out_r_TID");
    sc_trace(mVcdFile, grp_mnist_lstm_fu_70_out_r_TDEST, "grp_mnist_lstm_fu_70_out_r_TDEST");
    sc_trace(mVcdFile, grp_mnist_lstm_fu_70_ap_start_reg, "grp_mnist_lstm_fu_70_ap_start_reg");
...
void LSTM_Top::thread_ap_clk_no_reset_() {
    ...
    if ( ap_rst_n_inv.read() == ap_const_logic_1) {
        ...
        } else if (esl_seteq<1,1,1>(ap_const_logic_1, grp_mnist_lstm_fu_70_ap_ready.read())) {
            grp_mnist_lstm_fu_70_ap_start_reg = ap_const_logic_0;
        }
    }
    if ( ap_rst_n_inv.read() == ap_const_logic_1) {
    ...
    if (esl_seteq<1,1,1>(ap_const_logic_1, out_data_V_1_load_A.read())) {
        out_data_V_1_payload_A = grp_mnist_lstm_fu_70_out_r_TDATA.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, out_data_V_1_load_B.read())) {
        out_data_V_1_payload_B = grp_mnist_lstm_fu_70_out_r_TDATA.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, out_dest_V_1_load_A.read())) {
        out_dest_V_1_payload_A = grp_mnist_lstm_fu_70_out_r_TDEST.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, out_dest_V_1_load_B.read())) {
        out_dest_V_1_payload_B = grp_mnist_lstm_fu_70_out_r_TDEST.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, out_id_V_1_load_A.read())) {
        out_id_V_1_payload_A = grp_mnist_lstm_fu_70_out_r_TID.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, out_id_V_1_load_B.read())) {
        out_id_V_1_payload_B = grp_mnist_lstm_fu_70_out_r_TID.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, out_keep_V_1_load_A.read())) {
        out_keep_V_1_payload_A = grp_mnist_lstm_fu_70_out_r_TKEEP.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, out_keep_V_1_load_B.read())) {
        out_keep_V_1_payload_B = grp_mnist_lstm_fu_70_out_r_TKEEP.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, out_last_V_1_load_A.read())) {
        out_last_V_1_payload_A = grp_mnist_lstm_fu_70_out_r_TLAST.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, out_last_V_1_load_B.read())) {
        out_last_V_1_payload_B = grp_mnist_lstm_fu_70_out_r_TLAST.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, out_strb_V_1_load_A.read())) {
        out_strb_V_1_payload_A = grp_mnist_lstm_fu_70_out_r_TSTRB.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, out_strb_V_1_load_B.read())) {
        out_strb_V_1_payload_B = grp_mnist_lstm_fu_70_out_r_TSTRB.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, out_user_V_1_load_A.read())) {
        out_user_V_1_payload_A = grp_mnist_lstm_fu_70_out_r_TUSER.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, out_user_V_1_load_B.read())) {
        out_user_V_1_payload_B = grp_mnist_lstm_fu_70_out_r_TUSER.read();
    }
}
...
void LSTM_Top::thread_grp_mnist_lstm_fu_70_ap_start() {
    grp_mnist_lstm_fu_70_ap_start = grp_mnist_lstm_fu_70_ap_start_reg.read();
}

void LSTM_Top::thread_grp_mnist_lstm_fu_70_in_r_TVALID() {
    grp_mnist_lstm_fu_70_in_r_TVALID = in_dest_V_0_state.read()[0];
}

void LSTM_Top::thread_grp_mnist_lstm_fu_70_out_r_TREADY() {
    grp_mnist_lstm_fu_70_out_r_TREADY = ((out_data_V_1_ack_in.read() & 
...
void LSTM_Top::thread_in_data_V_0_ack_out() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read())) {
        in_data_V_0_ack_out = grp_mnist_lstm_fu_70_in_r_TREADY.read();
    } else {
...
void LSTM_Top::thread_in_dest_V_0_ack_out() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read())) {
        in_dest_V_0_ack_out = grp_mnist_lstm_fu_70_in_r_TREADY.read();
    } else {
...
void LSTM_Top::thread_in_id_V_0_ack_out() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read())) {
        in_id_V_0_ack_out = grp_mnist_lstm_fu_70_in_r_TREADY.read();
    } else {
...
void LSTM_Top::thread_in_keep_V_0_ack_out() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read())) {
        in_keep_V_0_ack_out = grp_mnist_lstm_fu_70_in_r_TREADY.read();
    } else {
...
void LSTM_Top::thread_in_last_V_0_ack_out() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read())) {
        in_last_V_0_ack_out = grp_mnist_lstm_fu_70_in_r_TREADY.read();
    } else {
...
void LSTM_Top::thread_in_strb_V_0_ack_out() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read())) {
        in_strb_V_0_ack_out = grp_mnist_lstm_fu_70_in_r_TREADY.read();
    } else {
...
void LSTM_Top::thread_in_user_V_0_ack_out() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read())) {
        in_user_V_0_ack_out = grp_mnist_lstm_fu_70_in_r_TREADY.read();
    } else {
...
void LSTM_Top::thread_out_data_V_1_vld_in() {
    out_data_V_1_vld_in = grp_mnist_lstm_fu_70_out_r_TVALID.read();
}
...
void LSTM_Top::thread_out_dest_V_1_vld_in() {
    out_dest_V_1_vld_in = grp_mnist_lstm_fu_70_out_r_TVALID.read();
}
...
void LSTM_Top::thread_out_id_V_1_vld_in() {
    out_id_V_1_vld_in = grp_mnist_lstm_fu_70_out_r_TVALID.read();
}
...
void LSTM_Top::thread_out_keep_V_1_vld_in() {
    out_keep_V_1_vld_in = grp_mnist_lstm_fu_70_out_r_TVALID.read();
}
...
void LSTM_Top::thread_out_last_V_1_vld_in() {
    out_last_V_1_vld_in = grp_mnist_lstm_fu_70_out_r_TVALID.read();
}
...
void LSTM_Top::thread_out_strb_V_1_vld_in() {
    out_strb_V_1_vld_in = grp_mnist_lstm_fu_70_out_r_TVALID.read();
}
...
void LSTM_Top::thread_out_user_V_1_vld_in() {
    out_user_V_1_vld_in = grp_mnist_lstm_fu_70_out_r_TVALID.read();
}
...
void LSTM_Top::thread_ap_NS_fsm() {
    switch (ap_CS_fsm.read().to_uint64()) {
        ...
        case 2 : 
            ...
            break;
        case 4 : 
            if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read()) && esl_seteq<1,1,1>(grp_mnist_lstm_fu_70_ap_done.read(), ap_const_logic_1))) {
