...
struct LSTM_Top : public sc_module {
    ...
    sc_signal< sc_logic > grp_mnist_lstm_fu_70_ap_start;
    sc_signal< sc_logic > grp_mnist_lstm_fu_70_ap_done;
    sc_signal< sc_logic > grp_mnist_lstm_fu_70_ap_idle;
    sc_signal< sc_logic > grp_mnist_lstm_fu_70_ap_ready;
    sc_signal< sc_logic > grp_mnist_lstm_fu_70_in_r_TVALID;
    sc_signal< sc_logic > grp_mnist_lstm_fu_70_in_r_TREADY;
    sc_signal< sc_lv<32> > grp_mnist_lstm_fu_70_out_r_TDATA;
    sc_signal< sc_logic > grp_mnist_lstm_fu_70_out_r_TVALID;
    sc_signal< sc_logic > grp_mnist_lstm_fu_70_out_r_TREADY;
    sc_signal< sc_lv<4> > grp_mnist_lstm_fu_70_out_r_TKEEP;
    sc_signal< sc_lv<4> > grp_mnist_lstm_fu_70_out_r_TSTRB;
    sc_signal< sc_lv<1> > grp_mnist_lstm_fu_70_out_r_TUSER;
    sc_signal< sc_lv<1> > grp_mnist_lstm_fu_70_out_r_TLAST;
    sc_signal< sc_lv<1> > grp_mnist_lstm_fu_70_out_r_TID;
    sc_signal< sc_lv<1> > grp_mnist_lstm_fu_70_out_r_TDEST;
    sc_signal< sc_logic > grp_mnist_lstm_fu_70_ap_start_reg;
    ...
    void thread_grp_mnist_lstm_fu_70_ap_start();
    void thread_grp_mnist_lstm_fu_70_in_r_TVALID();
    void thread_grp_mnist_lstm_fu_70_out_r_TREADY();
