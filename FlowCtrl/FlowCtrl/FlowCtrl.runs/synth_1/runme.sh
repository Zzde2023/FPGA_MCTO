...
HD_PWD='F:/Project/FlowCtrl/FlowCtrl/FlowCtrl.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log flow_ctrl.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source flow_ctrl.tcl
